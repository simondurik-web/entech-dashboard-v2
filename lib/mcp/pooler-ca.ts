// Supabase transaction-pooler CA chain (PUBLIC server cert — safe to commit).
// Inlined so TLS pinning works on Vercel serverless without file-tracing.
// Refresh: openssl s_client -connect aws-1-us-east-2.pooler.supabase.com:6543 \n//   -starttls postgres -showcerts
export const POOLER_CA = `-----BEGIN CERTIFICATE-----
