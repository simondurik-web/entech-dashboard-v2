  ...
  return (
    <div className="p-4 md:p-6 space-y-4">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">Sales by Part Number</h1>
          <p className="text-sm text-muted-foreground">{partSummaries.length} parts from shipped orders</p>
        </div>
        <input
          type="text"
            ...
            <thead>
              <tr className="bg-muted/50">
                ...
                <th className="px-3 py-3 text-left font-medium cursor-pointer hover:bg-muted" onClick={() => handleSort('partNumber')}>
                  <span className="flex items-center gap-1">Part # <ArrowUpDown className="h-3 w-3" /></span>
                </th>
                    ...
                    <tr key={`${part.partNumber}-expanded`}>
                      <td colSpan={9} className="bg-muted/20 px-6 py-3">
                        <div className="text-xs space-y-2">
                          <p className="font-semibold text-muted-foreground mb-2">Individual Orders:</p>
                          <div className="overflow-x-auto">
