      ...
      <div className="rounded-xl border border-white/10 bg-white/5 p-8 text-center">
        ...
        {!user && (
          <>
            ...
            {/* Passwordless email LOGIN CODE — corporate-inbox-safe typed code
                (replaces the magic link). Themed variant for the in-app card. */}
            <EmailCodeLogin redirectTo={pathname || "/orders"} />
